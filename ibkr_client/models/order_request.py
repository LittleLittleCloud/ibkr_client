...
class OrderRequest(object):
    ...
    def __init__(self, acct_id=None, conid=None, sec_type=None, c_oid=None, parent_id=None, order_type=None, listing_exchange=None, outside_rth=None, price=None, side=None, ticker=None, tif=None, referrer=None, quantity=None, fx_qty=None, use_adaptive=None, is_currency_conversion=None, allocation_method=None):  # noqa: E501
