...
class ContractApi(object):
    ...
    def iserver_secdef_info_get(self, conid, sectype, **kwargs):  # noqa: E501
        ...
        For option and warrant, you can get strike price from \"/iserver/secdef/strikes\" endpoint. Must call /secdef/search for the underlying contract first.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def iserver_secdef_search_post(self, symbol, **kwargs):  # noqa: E501
        ...
        Specify an underlying to search what derivative contract(s) it has. This endpoint must be called before using /secdef/info  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param async_req bool
        :param Symbol symbol: Symbol or Company Name to be searched (required)
    ...
    def trsrv_secdef_post(self, body, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param Body8 body: request body (required)
        :return: Secdef
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def trsrv_secdef_schedule_get_with_http_info(self, asset_class, symbol, **kwargs):  # noqa: E501
        ...
        all_params = ['asset_class', 'symbol', 'exchange']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
