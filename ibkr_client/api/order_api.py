...
class OrderApi(object):
    ...
    def iserver_account_account_id_orders_post(self, account_id, body, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param str account_id: account id (required)
        :param Body6 body: order request info (required)
        :return: list[InlineResponse20014]
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def iserver_account_orders_fa_group_post(self, fa_group, body, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.iserver_account_orders_fa_group_post(fa_group, body, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.iserver_account_orders_fa_group_post_with_http_info(fa_group, body, **kwargs)  # noqa: E501
        else:
            (data) = self.iserver_account_orders_fa_group_post_with_http_info(fa_group, body, **kwargs)  # noqa: E501
            return data

    def iserver_account_orders_fa_group_post_with_http_info(self, fa_group, body, **kwargs):  # noqa: E501
        """Place Orders for Financial Advisor Groups  # noqa: E501

        Financial Advisors can use this endpoint to place an order for a specified group. To place an order for a specified account use the endpoint /iserver/account/{accountId}/order. More information about groups can be found in the [TWS Users' Guide:](https://guides.interactivebrokers.com/twsguide/twsguide.htm#usersguidebook/financialadvisors/create_an_account_group_for_share_allocation.htm).   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.iserver_account_orders_fa_group_post_with_http_info(fa_group, body, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['fa_group', 'body']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def iserver_reply_replyid_post(self, replyid, body, **kwargs):  # noqa: E501
        ...
        :param Body7 body: Answer to question (required)
