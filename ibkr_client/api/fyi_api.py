...
class FYIApi(object):
    ...
    def fyi_deliveryoptions_device_post(self, body, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param Body1 body: device info (required)
    ...
    def fyi_settings_typecode_post(self, typecode, body, **kwargs):  # noqa: E501
        """enable/disable certain subscription  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.fyi_settings_typecode_post(typecode, body, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.fyi_settings_typecode_post_with_http_info(typecode, body, **kwargs)  # noqa: E501
        else:
            (data) = self.fyi_settings_typecode_post_with_http_info(typecode, body, **kwargs)  # noqa: E501
            return data

    def fyi_settings_typecode_post_with_http_info(self, typecode, body, **kwargs):  # noqa: E501
        """enable/disable certain subscription  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.fyi_settings_typecode_post_with_http_info(typecode, body, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['typecode', 'body']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def fyi_unreadnumber_get(self, **kwargs):  # noqa: E501
        """Get unread number of fyis  # noqa: E501
